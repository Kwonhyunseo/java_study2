 ...
 *=>기본형을 클래스화 해서 사용 
 *  ------------ Wrapper
 *  기본형        클래스형 => 기본형에 기능에 추가해서 클래스화 시킨것 (Wrapper)
 *  int         Integer
 *  long        Long
 *  byte        Byte
 *  double     Double
...
public class 라이브러리_Wrapper_1 {
	...
	public static void main(String[] args) {
		...
		// 사용처 => 문자열을 원하는 데이터형으로 변경할떄 주로 사용 
		// => 클라이언트에 배포 =>윈도우/ 브라우저/ 핸드폰 
		//=======> 모든 데이터형 문자열 =>기본형 데이터으로 변경 
		// 클래스명 : 객체 단위로 저장(List<>)
		//문자열 => 해당 데이터형으로 변환 ==> parseXxxxx
		// 오토박싱 / 언박싱 
		/*
		 *  오토박싱 
