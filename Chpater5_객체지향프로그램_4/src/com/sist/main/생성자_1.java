 ...
 *            => int a;
 *               a=10;=> 구현 => 변수의 초기화  (생성자) 
 *            => 생성시점 : new 를 이용해서 메모리 공간이 확보  
 *               소멸시점 : 객체= null이거나 사용하지 않는 경우
 *                       ------------------ 가비지 컬렉션 (메모리 회수)
 *            => 가장 많이 사용 되는 변수 ( 여러개를 저장)
 *            => 사용하는 방법
 *               class A
 *               {
 *                   int age; //0
 ...
 *          String addr2, String te1,String email)
 *          (Member m )
 *          
 *          메소드 유형 
