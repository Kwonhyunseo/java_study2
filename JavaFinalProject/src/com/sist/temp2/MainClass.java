 ...
 *   =>수 표현에 따라 크기가 달라진다.
 *   ---------------------------------------30page
 *   변수 생성방법(식별자) =>같은 메소드상에서는 같은 변수가 존재하지 않는다.
 *   =식별자
 ...
 *              오라클 : =,<>,^=
 *              자바스크립트:===,!==
 *           => 논리연산자 : &&(직렬) =>두개가 true일때 true, ||(병렬)=> 둘중에 1개이상 ture일때 true
 *             ****효율적인 연산 
 *            && =>앞에조건 false=>뒤에 조건은 수행하지 않는다
 *            ------ 포함 
 *             || => 앞에 조건true =>뒤에 조건은 수행하지 않는다.   
 *             ---- 포함이 안된 경우 
 *        =>대입연산자: 결과값 대입
 *                   =,+=,-=
 *                   int a=10;
 ...
 *             리턴형                매개변수
 *        ----------------------------------
 *               0                   0=> 오라클 :SELECT => 클래스 /컬렉션 
 *                ***** => page구분
 *        ----------------------------------
 *               0                   x => 오라클 :SELECT
 *        ----------------------------------
 *               x                   0 => 오라클 :INSERT/UPDATE/DELETE
 *                                        오라클 자체에서 수행 
 *                 ***=>추가할 데이터 첨부
 *        ----------------------------------
 *               x                   x  
