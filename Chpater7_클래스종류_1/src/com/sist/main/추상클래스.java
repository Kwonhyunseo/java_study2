 ...
 *  예) 
 *     게시판 : 목로출력 , 찾기, 글쓰기 , 내용보기 , 수정하기, 삭제하기 
 *     묻고답하기 :목로출력 , 찾기, 글쓰기 , 내용보기 , 수정하기, 삭제하기 ,답변하기 
 *     댓글게시판 :목로출력 , 찾기, 글쓰기 , 내용보기 , 수정하기, 삭제하기 ,댓글
 *     후기게시판 : 목로출력 , 찾기, 글쓰기 , 내용보기 , 수정하기, 삭제하기 ,업로드 
 *     ---
 *     ---
 *     ---
 *     ---
 ...
 *           abstract class A
 *           =>A a=new A() =>X
 *       3) 상속을 내려서 구현된 클래스를 이용해서 매모리 할당
 *          abstract class A
 *          class B extends A
 *          -------------------- 구현이 안된 메소드를 구현한다
 *          => A a = new B(); 묵시적 형변환 
